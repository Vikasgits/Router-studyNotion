...
return(
    <div> 
        <div className='flex rounded-full bg-richblack-800 p-1 gap-x-1  max-w-max'>
            <button 
                className={`${accoutType==="student" ? "bg-richblack-900 text-richblack-5": 
            ...
            <button 
                className={`${accoutType==="instructor" ? "bg-richblack-900 text-richblack-5": 
                "bg-transparent text-richblack-200"} py-2 px-5 rounded-full transition-all duration-200`}
        ...
        <form onClick={submitHandler} >
            ...
            {/* firstName and lastName */}
                <label>
                    ...
                    className="bg-richblack-800 rounded-[0.75rem] text-richblack-5 
                    w-full p-[12px]" />
                </label>
